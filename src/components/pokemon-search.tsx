...
export default class App extends Component<IAppProps, ISearchState> {
    ...
    async searchPokemon(searchKey: string) {
        ...
        try {
            let response = await fetch(`https://pokeapi.co/api/v2/pokemon/${searchKey}`);
    ...
    public render() {
        ...
        return (
            ...
            <div>
                ...
                <button className="my-button" onClick={this.onSearchClicked}>Search</button>
                {resultMarkup}
            </div>
        );
    }
